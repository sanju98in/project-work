...
public class DebtorEnquiries64832 extends DebtorsEnquiriesWorkflow {

   @Test(groups = {"smoke"})
    public void VerifyTheAuthorisedTransactionsDBDetailsEnquiryPage() throws Exception {
    ...
    createUnallocatedManualPaymentForDebtorEnquiries(uniqueDebtorNumber,
    ...
    verifyCreditNoteAndPaymentDetails(dbInvoiceAmount, DebtorsCreditNotesWorkflow.getDBCreditLineAmount(msgprop.getProperty("lblauthorisedinvoices")));
