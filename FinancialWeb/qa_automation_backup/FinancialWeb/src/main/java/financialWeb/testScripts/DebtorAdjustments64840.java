...
public class DebtorAdjustments64840 extends DebtorAdjustmentsWorkflow {

  @Test(groups = {"smoke"})

  public void allocateReversePaymenttoanunallocatedCreditNote()
   ...
   uniqueDebtorNumber = DebtorMaintenanceWorkflow.createDebtor();
    ...
    DebtorPaymentsWorkflow.validateOutstandingAmount(outstanding,amount,allocated);

    //Verify Existing Allocations Table
    searchTableColumn(orprop.getProperty("existingallocationstable"),referenceNo);
    outstanding = "£"+ outstanding;
    searchTableColumn(orprop.getProperty("existingallocationstable"),outstanding);
