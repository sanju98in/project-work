...
public class GLMaintenance65256 extends GLMaintenanceWorkflow{
  
  @Test(groups = {"smoke"})
  public void  clearCostCenter() throws InterruptedException, ParseException, IOException, URISyntaxException {
