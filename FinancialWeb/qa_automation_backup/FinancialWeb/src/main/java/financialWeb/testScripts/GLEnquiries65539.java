...
public class GLEnquiries65539 extends GLEnquiriesWorkflow{
  
  @Test(groups = {"smoke"})
  public void  findDetailCodeAnalysisCodeOnGLHighLevelEnquiryPage() throws InterruptedException, ParseException, IOException, URISyntaxException {
