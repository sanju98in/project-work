...
public class DebtorMaintenance63761 extends DebtorMaintenanceWorkflow{

 @Test(groups = {"smoke"})
  public void deletingContactForDebtor() throws InterruptedException, ParseException, IOException {
    ...
    searchAndClickLatestRecordInTable(orprop.getProperty("contacttable"),testdataprop.getProperty("delete"));
