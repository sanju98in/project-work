...
public class CreditorsMaintenance62483 extends CreditorMaintenanceWorkflow {

  @Test(groups = {"smoke"})
  public void amendingCreditors() throws InterruptedException, ParseException, IOException {
