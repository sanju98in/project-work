...
public class GLEnquiries65545 extends GLEnquiriesWorkflow {

  @Test(groups = {"smoke"})
  public void findCodeLevelEnquiries()
    ...
    GLMaintenanceWorkflow.verifyAndCreateCostCenterDimensions(
        testdataprop.getProperty("searchorcreatecontroldata"),
        testdataprop.getProperty("detailcodedimensionvalue"),
        testdataprop.getProperty("costcentredimensiondesc"));

    analysisCode = GLMaintenanceWorkflow.createCostCentreAnalysis(
        testdataprop.getProperty("costcentreanalysissetcode"),
