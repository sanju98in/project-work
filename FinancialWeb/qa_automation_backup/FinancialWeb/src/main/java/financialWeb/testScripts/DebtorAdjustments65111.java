...
public class DebtorAdjustments65111 extends DebtorAdjustmentsWorkflow {

  @Test(groups = {"smoke"})
  
  public void setupTidyTransactionBTWNDebtorsFullyMatchTransaction()
    ...
    setCrNoteTidyAmt(testdataprop.getProperty("amount"));
    setInvoiceTidyAmt(testdataprop.getProperty("amount"));
