...
public class GLMaintenance65252 extends GLMaintenanceWorkflow{
  
  @Test(groups = {"smoke"})
  public void  createCostCenter() throws InterruptedException, ParseException, IOException, URISyntaxException {
